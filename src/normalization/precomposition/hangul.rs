...
pub fn compose_hangul(first: u32, second: u32) -> Option<u32>
{
    ...
    if l < HANGUL_L_COUNT {
        ...
        if v < HANGUL_V_COUNT {
            let code = HANGUL_S_BASE + l * HANGUL_N_COUNT + v * HANGUL_T_BLOCK_SIZE;
            return Some(code);
        }
    }
    ...
    if lv < HANGUL_S_COUNT && lv % HANGUL_T_BLOCK_SIZE == 0 {
...
pub fn is_composable_hangul(code: u32) -> bool
{
    ...
    (l < HANGUL_L_COUNT) || (lv < HANGUL_S_COUNT && lv % HANGUL_T_BLOCK_SIZE == 0)
}
...
pub fn is_composable_hangul_jamo(code: u32) -> bool
{
    ...
    (v < HANGUL_V_COUNT) || (t < HANGUL_T_COUNT)
}
